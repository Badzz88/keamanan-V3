...
async function KIdzABbys(jid, mention) {
  try {
    let msg = await generateWAMessageFromContent(
      jid,
      {
        buttonsMessage: {
          ...
          footerText: "⎋🦠</🧬⃟༑⌁⃰𝙏𝙝𝙧𝙚𝙚𝘽𝙧𝙤𝙩𝙝𝙚𝙧𝙨ཀ\\>🍷𞋯",
          buttons: [
            {
              buttonId: "null",
              buttonText: {
    ...
    console.error("❌ Error di KIdzABbys:", err);
  }
}
...
async function Love(sock, jid, mention = true) {
  try {
    ...
    console.log("✅ delay love selesai 2000x loop");
  } catch (err) {
    console.error("❌ Error di storyOfMyLive:", err);
  }
}
...
◇ 𝐎𝐖𝐍𝐄𝐑 : @sallstecu
◇ 𝐏𝐄𝐍𝐆𝐈𝐑𝐈𝐌 𝐁𝐔𝐆 : @${msg.from.username}
◇ 𝐄𝐅𝐄𝐊 𝐁𝐔𝐆 : DELAY NYEDOT KOUTA 4GB
◇ 𝐊𝐎𝐑𝐁𝐀𝐍 : ${formattedNumber}
NOTE: JEDA 20 MENIT AGAR SENDER BUG TIDAK CEPET COPOT/OVERHEAT
`,
        parse_mode: "Markdown",
...
◇ 𝐎𝐖𝐍𝐄𝐑 : @sallstecu
◇ 𝐏𝐄𝐍𝐆𝐈𝐑𝐈𝐌 𝐁𝐔𝐆 : @${msg.from.username}
◇ 𝐄𝐅𝐄𝐊 𝐁𝐔𝐆 : DELAY HARD NYEDOT KOUTA 10GB
◇ 𝐊𝐎𝐑𝐁𝐀𝐍 : ${formattedNumber}
NOTE: JEDA 20 MENIT AGAR SENDER BUG TIDAK CEPET COPOT/OVERHEAT
`,
        parse_mode: "Markdown",
